        ...
        <div class="card-header container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <a href="{{ route ('teacherSchedules.create')}}" class="btn btn-primary">Add Teacher</a>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <form action="{{route('teacherSchedules.index')}}" method="GET">
                        <div class="mb-3 row">
                            <div class="col-sm-9">
                ...
                <tbody>
                    @foreach ($teachers as $teacher)
                        <tr>
                            ...
                            <td width="2px">
                                <a href="{{ route('teacherSchedules.show', $teacher)}}" class="btn btn-primary btn-sm mb-2">Show</a>
                            </td>
                            <td width="5px">
                                <a href="{{route ('teacherSchedules.edit', $teacher)}}" class="btn btn-primary btn-sm mb-2">Edit</a>
                            </td>
                            <td width="5px">
                                <form action="{{route('teacherSchedules.destroy', $teacher)}}" method="POST">
                                    @csrf
                                    @method('DELETE')
