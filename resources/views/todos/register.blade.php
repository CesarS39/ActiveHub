    ...
    >
      <div class="max-w-xl lg:max-w-3xl">
        <div class="relative -mt-16 block lg:hidden">
          ...
          <h1 class="mt-2 text-2xl font-bold text-blue-700 sm:text-3xl md:text-4xl">
            Welcome to Squid 🦑
          </h1>

          <p class="mt-4 leading-relaxed text-blue-700">
        ...
        <form action="#" class="mt-8 grid grid-cols-6 gap-6">
          ...
          <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
            ...
            <p class="mt-4 text-sm text-gray-500 sm:mt-0">
              ...
              <a href="http://127.0.0.1:8000/login" class="text-blue-700 underline">Log in</a>.
            </p>
          </div>
        </form>
      </div>
