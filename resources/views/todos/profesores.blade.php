...
<section class="bg-gradient-to-b from-blue-500 to-white text-white">
  ...
  <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
    <div>
      <p class="inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider text-white uppercase rounded-full bg-teal-accent-400">
        Core Team
      </p>
    </div>
    <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
      <span class="relative inline-block">
        ...
        <span class="relative text-blue-700">Welcome our talented team of professionals</span>
      </span>
      
    </h2>
    <p class="text-base text-white md:text-lg">
    Highly qualified in their areas with years of experience and an immense passion for their sport
    </p>
  </div>
  <div class="grid gap-10 mx-auto sm:grid-cols-2 lg:grid-cols-4 lg:max-w-screen-lg">
    <div>
      ...
      <div class="flex flex-col sm:text-center">
        <p class="text-lg font-bold text-blue-700">Oliver Aguilerra</p>
        <p class="mb-5 text-xs text-gray-800">Ex ATP 100 player</p>
        <div class="flex items-center space-x-3 sm:justify-center">
          <a href="/" class="text-blue-700 transition-colors duration-300 hover:text-deep-purple-accent-400">
    ...
    <div>
      ...
      <div class="flex flex-col sm:text-center">
        <p class="text-lg font-bold text-blue-700">Marta Clermont</p>
        <p class="mb-5 text-xs text-gray-800">Padel and tennis expert</p>
        <div class="flex items-center space-x-3 sm:justify-center">
          <a href="/" class="text-blue-700 transition-colors duration-300 hover:text-deep-purple-accent-400">
            <svg viewBox="0 0 24 24" fill="currentColor" class="h-5">
              <path
    ...
    <div>
      ...
      <div class="flex flex-col sm:text-center">
        <p class="text-lg font-bold text-blue-700">Alice Melbourne</p>
        <p class="mb-5 text-xs text-gray-800">Physiotherapist and yoga expert</p>
        <div class="flex items-center space-x-3 sm:justify-center">
          <a href="/" class="text-blue-700 transition-colors duration-300 hover:text-deep-purple-accent-400">
            <svg viewBox="0 0 24 24" fill="currentColor" class="h-5">
              <path
    ...
    <div>
      ...
      <div class="flex flex-col sm:text-center">
        ...
        <p class="mb-5 text-xs text-gray-800">Former professional cyclist</p>
        <div class="flex items-center space-x-3 sm:justify-center">
          <a href="/" class="text-blue-700 transition-colors duration-300 hover:text-deep-purple-accent-400">
            <svg viewBox="0 0 24 24" fill="currentColor" class="h-5">
              <path
